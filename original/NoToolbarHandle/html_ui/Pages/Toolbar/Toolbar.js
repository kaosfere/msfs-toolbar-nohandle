...
class ToolBarElement extends UIElement {
    ...
    connectedCallback() {
        ...
        this.addEventListener('mouseleave', () => {
            ...
            this.mouseOutTimeout = setTimeout(this.toggleToolbar.bind(this, false), 300);
        });
    ...
    reorderButtons() {
        let buttonList = Array.from(this.querySelectorAll('toolbar-button'));
        buttonList.sort((a, b) => {
